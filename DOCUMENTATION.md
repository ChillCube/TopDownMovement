...
| **acceleration** | `float` | `1` | Ramp-up rate (1 = instant, 0 = never accelerates) |
| **deceleration** | `float` | `0.1` | Ramp-down rate (1 = instant stop) |
| **enable_dashing** | `bool` | `true` | Allow the dash mechanic |
| **dash_speed** | `float` | `5` | Speed multiplier during a dash |
| **dash_time** | `float` | `0.5` | Duration in seconds of each dash |
...
| **knockback_speed** | `float` | `5` | Speed multiplier for knockback impulse |
| **knockback_time** | `float` | `0.5` | Duration in seconds the knockback force is applied |
